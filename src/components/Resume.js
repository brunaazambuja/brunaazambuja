    ...
    <ResumeContainer>
      <div className="opacity">
        ...
        <div className="card left" style={{ top: "34rem" }}>
          <strong>{text.gloria_micsft}</strong> Instituto Glória &#38; Microsoft <p>(10/2021 - 2/2022)</p>
        </div>
        <div className="card right" style={{ top: "36rem" }}>
          <strong>{text.tukey}</strong> Tukey Data <p>(08/2021 - {text.atualmente})</p>
        </div>
        <div className="card left" style={{ top: "42rem" }}>
          <strong>{text.li}</strong> Loja Integrada <p>(4/2022 - {text.atualmente})</p>
        </div>
      </div>
    </ResumeContainer>
  );
