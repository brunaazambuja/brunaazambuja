  ...
  return (
    <SkillsContainer>
      ...
      <div className="skills">
        <div className="tech">
          <strong>ReactJs / React Native</strong><Slider disabled defaultValue={95} className="slider" />
          <strong>NodeJs</strong><Slider disabled defaultValue={95} className="slider" />
          <strong>Python</strong><Slider disabled defaultValue={84} className="slider" />
          <strong>Machine Learning</strong><Slider disabled defaultValue={80} className="slider" />
          <div className="loading_title">
            <strong>Flutter</strong>
            {/* <div className="loading-spinner"/> */}
          </div>
          <Slider disabled defaultValue={53} className="slider" />
        </div>
